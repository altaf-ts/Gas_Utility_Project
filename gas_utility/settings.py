...
# Security settings
SECRET_KEY = 'django-insecure-cy!778-9^uzb0!%b-&_ju89ngb#b0xbb%gc770f-g#7h3i9^%='
DEBUG = True
ALLOWED_HOSTS = []
...
INSTALLED_APPS = [
    ...
    'customer_service',  # Include the customer_service app
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            BASE_DIR / 'customer_service/templates/customer_service',  # Ensure the path is correct
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
